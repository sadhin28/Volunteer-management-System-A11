...
export default function AuthForm() {
 ...
 const provider = new GoogleAuthProvider();
  ...
  return (
    <div className="relative top-10 flex items-center justify-center  px-1 min-h-[calc(100vh-100px)]">
      <div className="border-2  border-[#511AB7FF] hover:shadow-2xl shadow-lg bg-gray-100/20 p-8 rounded-2xl shadow-lg w-full max-w-2xl ">
